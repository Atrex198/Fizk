...
**Run Directory:** `run_20251008_192743_clients3_rounds3`
...
- **Total Time:** 89.92s
- **Final Accuracy:** 0.6841
- **Accuracy Improvement:** 0.0018
- **Total Proofs Generated:** 9
- **Avg Proof Size:** 2306 bytes
- **Avg Time per Round:** 29.97s

## Round-by-Round Performance

| Round | Verified Clients | Avg Accuracy | Avg Loss | Proof Size (bytes) | Round Time (s) |
|-------|------------------|--------------|----------|-------------------|----------------|
| 1 | 3/3 | 0.6823 | 0.6100 | 2306 | 27.66 |
| 2 | 3/3 | 0.6926 | 0.5902 | 2305 | 31.37 |
| 3 | 3/3 | 0.6841 | 0.5979 | 2305 | 30.89 |

## Directory Structure

```
run_20251008_192743_clients3_rounds3/
├── proofs/
