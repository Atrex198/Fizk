...
**Run Directory:** `run_20251203_075509_clients2_rounds3`
...
- **Total Time:** 719.82s
- **Final Accuracy:** 0.7316
- **Accuracy Improvement:** 0.0281
- **Total Proofs Generated:** 6
- **Avg Proof Size:** 9593 bytes
- **Avg Time per Round:** 239.94s

## Round-by-Round Performance

| Round | Verified Clients | Avg Accuracy | Avg Loss | Proof Size (bytes) | Round Time (s) |
|-------|------------------|--------------|----------|-------------------|----------------|
| 1 | 2/2 | 0.7035 | 0.6039 | 9192 | 241.41 |
| 2 | 2/2 | 0.7193 | 0.5776 | 9593 | 260.13 |
| 3 | 2/2 | 0.7316 | 0.5577 | 9994 | 218.19 |

## Directory Structure

```
run_20251203_075509_clients2_rounds3/
├── proofs/
