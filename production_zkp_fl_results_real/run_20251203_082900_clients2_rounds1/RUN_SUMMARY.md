...
**Run Directory:** `run_20251203_082900_clients2_rounds1`
...
- **Total Time:** 198.41s
- **Final Accuracy:** 0.7198
- **Accuracy Improvement:** 0.0000
- **Total Proofs Generated:** 2
- **Avg Proof Size:** 9196 bytes
- **Avg Time per Round:** 198.41s

## Round-by-Round Performance

| Round | Verified Clients | Avg Accuracy | Avg Loss | Proof Size (bytes) | Round Time (s) |
|-------|------------------|--------------|----------|-------------------|----------------|
| 1 | 2/2 | 0.7198 | 0.5779 | 9196 | 198.39 |

## Directory Structure

```
run_20251203_082900_clients2_rounds1/
├── proofs/
